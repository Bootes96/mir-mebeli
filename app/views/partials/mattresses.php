                    ...
                    <div class="col-md-6">
                        <div class="product p-4">
                            <div class="mt-4 mb-3"> <span class="text-uppercase text-muted brand"><?= $product['brand_title']; ?></span>
                                ...
                                <div class="price d-flex flex-row align-items-center"><span class="act-price">Цена: <?= $product['price']; ?> рублей</span>
                                    <div class="ml-2"> <small class="dis-price"></small><span>40% OFF</span> </div>
                                </div>
                            </div>
                            <p class="product-attribute">Жесткость: <?= $product['stiffness']; ?></p>
                            <p class="product-attribute">Материалы наполнителя: <?= $product['filler_materials']; ?></p>
                            <p class="product-attribute">Высота спального места: <?= $product['heigth']; ?></p>
